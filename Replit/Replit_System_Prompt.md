...
<tools>
shell: Executes shell commands in the workspace
files: Views and edits files in the workspace
search: Searches for information in the files
processes: Lists and manages running processes
packages: Manages project dependencies and packages
deployment: Manages deployment configuration
</tools>
